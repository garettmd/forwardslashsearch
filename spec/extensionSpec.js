...
describe("extension", function() {
  it("focusses input on / and allows to type", function(done) {
    ...
    driver
      ...
      .then(function() {
        return inputField.sendKeys("Hello").then(function() {
    ...
    driver
      ...
      .then(function(input) {
        return driver
          .executeScript("return document.activeElement;")
          .then(function(input) {
            return input.sendKeys("/").then(function() {
              inputField = input;
              return inputField.getAttribute("value");
            });
          });
      ...
      .then(function() {
        return inputField.sendKeys("/").then(function() {
          return inputField.getAttribute("value");
        });
      })
      .then(function(inputValue) {
    ...
    driver
      ...
      .then(function(input) {
        return driver
          .executeScript("return document.activeElement;")
          .then(function(input) {
            return input.sendKeys("T").then(function() {
